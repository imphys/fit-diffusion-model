function [S,J] = bitensor_adc_fitmri(theta,Q,opts)
% bitensor_adc_fitmri
% theta1: alpha1
% theta2: alpha2
% theta3: alpha3
...
%     dSdlambda1 = Q*Dtemp.*Stensor;
    ...
    %% Compute derivatives for C1 and C2
    J(:,:,4) = dSdlambda2.*repmat(lambda1,nMRI,1);
    J(:,:,5) = dSdlambda3.*repmat(lambda2,nMRI,1);
