function [S,J] = bitensor_fitmri(theta,Q,opts)
% bitensor_fitmri
% theta1: alpha1
% theta2: alpha2
% theta3: alpha3
...
if nargout==2
    ...
    J(:,:,6) = Q*Dtemp.*Stensor*d_max;
    
    %% Derivative to f
    J(:,:,7) = repmat(S0,nMRI,1).*(Atensor-Aiso);
    
    %% Derivative to S0
    J(:,:,8) = S./repmat(S0,nMRI,1);
