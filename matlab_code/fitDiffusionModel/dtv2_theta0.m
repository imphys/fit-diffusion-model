function theta0_cell = dtv2_theta0(S0,DT,mask,opts)
%% dtv2_theta0
...
for i=1:size(theta0a_mask,2)
    ...
    theta0a_mask(:,i) = [C1;C2;C3;C4;theta1;phi1;theta2;phi2;S0_mask(i)];
    ...
    theta0b_mask(:,i) = [C1;C2;C3;C4;theta1;phi1;theta2;phi2;S0_mask(i)];
