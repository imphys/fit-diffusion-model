function theta0_cell = balland2sticks_2timepoints_theta0(~,~,data,Q,fields,mask,opts)
...
%     EV2 = [rand; rand; rand]; EV2 = EV2./norm(EV2);
    ...
    ball_signal_A = S0_mask_A(i)*exp(Q(n1,:)*ball);
    A = [tensor1_signal,tensor2_signal,ball_signal_A];
    ...
    theta0a_mask(:,i) = [C1A;C2A;C3A;S0_mask_A(i);C1B;C2B;C3B;S0_mask_B(i);theta1;phi1;theta2;phi2];
    theta0b_mask(:,i) = [C1A;0.5;0.5;S0_mask_A(i);C1B;0.5;0.5;S0_mask_B(i);theta1;phi1;theta2;phi2];
