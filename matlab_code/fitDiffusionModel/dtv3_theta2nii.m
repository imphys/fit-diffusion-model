function dtv3_theta2nii(theta_mask,dwi_header,dir_output,mask,sigma_mask,resnorm_mask,logLL_mask,opts)
%% dtv3_theta2nii
...
thetaConverted(9,:) = theta_mask(7,:);
thetaConverted(10,:) = theta_mask(8,:);
