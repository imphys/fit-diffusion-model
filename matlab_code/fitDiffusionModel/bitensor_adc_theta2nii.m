function bitensor_adc_theta2nii(theta_mask,dwi_header,dir_output,mask,sigma_mask,resnorm_mask,logLL_mask,opts)
%% bitensor_adc_theta2nii
% theta1: alpha1
% theta2: alpha2
% theta3: alpha3
...
%% Prepare S0, f and diso and write to disk
fn_STniiS0 = [dir_output 'ST_S0.nii.gz'];
save_to_disk(dwi_header,fn_STniiS0,S0,mask);

fn_STniif = [dir_output 'ST_f_tensor.nii.gz'];
save_to_disk(dwi_header,fn_STniif,f,mask);

fn_STniifiso = [dir_output 'ST_f_iso.nii.gz'];
save_to_disk(dwi_header,fn_STniifiso,fiso,mask);
