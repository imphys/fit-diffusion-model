function [CRLB,Il,Jl] = CramerRaoLowerBound_MRI(par, fun, sigma, imagetype, fields)
% [CRLB,I,J] = CramerRaoLowerBound_MRI(par, fun, sigma, imagetype, fields)
...
% originally created from CramerRaoDT (Original version: 6-9-2007)
% 22-3-2011 
% 12-5-2011 : added support for fields
